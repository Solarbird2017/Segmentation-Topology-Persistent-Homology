...
figure(2), imshow3D(new_intensity3d,[-40,40]);
mV_intensity = -40;
for j=1:size(halfVal_1,1)
    new_intensity3d(halfVal_1(j,1),halfVal_1(j,2),halfVal_1(j,3)) = mV_intensity;
end
for j=1:size(halfVal_2,1)
    new_intensity3d(halfVal_2(j,1),halfVal_2(j,2),halfVal_2(j,3)) = mV_intensity;
end

figure(4), imshow3D(new_intensity3d,[-40,40]);
